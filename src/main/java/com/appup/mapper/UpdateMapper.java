...
public interface UpdateMapper {
    ...
    @Select("select * from appupdate_test where version=#{version} and platform=#{platform}")
    ...
    @Delete("delete from appupdate_test where version=#{version} and platform =#{platform}")
